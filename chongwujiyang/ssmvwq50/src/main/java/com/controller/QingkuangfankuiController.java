...
//			qingkuangfankui.setZhanghao((String)request.getSession().getAttribute("username"));
//		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,QingkuangfankuiEntity qingkuangfankui, HttpServletRequest request){
        EntityWrapper<QingkuangfankuiEntity> ew = new EntityWrapper<QingkuangfankuiEntity>();
		PageUtils page = qingkuangfankuiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, qingkuangfankui), params), params));
        return R.ok().put("data", page);
    }
