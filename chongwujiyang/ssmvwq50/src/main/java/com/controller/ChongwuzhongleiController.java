...
public class ChongwuzhongleiController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ChongwuzhongleiEntity chongwuzhonglei, HttpServletRequest request){
        EntityWrapper<ChongwuzhongleiEntity> ew = new EntityWrapper<ChongwuzhongleiEntity>();
		PageUtils page = chongwuzhongleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, chongwuzhonglei), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ChongwuzhongleiEntity> wrapper = new EntityWrapper<ChongwuzhongleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = chongwuzhongleiService.selectCount(wrapper);
